...
export default function ReportsHeavyPage() {
  ...
  const handleDownloadChecklist = (checklist: WithId<Checklist>, vehicle: WithId<Vehicle>) => {
    ...
    doc.setFontSize(18);
    doc.text('ROTA CERTA - Relatório de Checklist (Frota Pesada)', 14, 22);
    doc.setFontSize(11);
    ...
    doc.save(`checklist-pesado-${vehicle.plate}-${checklist.id.substring(0, 5)}.pdf`);
  };
    ...
    <div className="mx-auto w-full max-w-7xl space-y-6">
      <div>
        <h1 className="text-2xl font-bold tracking-tight">
          Histórico de Checklist (Frota Pesada)
        </h1>
        <p className="text-muted-foreground">
          Visualize o histórico completo de checklists da frota de veículos pesados.
        </p>
      </div>
